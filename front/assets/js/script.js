 ...
 * Script Principal com Tradução PT/EN
 */
...
const translations = {
    pt: {
        ...
        heroTitleSpan: "com Elegância",
        heroDescription: "Transforme sua silhouette com tratamentos exclusivos de harmonização glútea. Na Dra. Lolla, combinamos tecnologia de ponta com cuidado personalizado para proporcionar resultados naturais e deslumbrantes.",
        heroButton: "Ver Serviços",
        ...
        service1Title: "Harmonização",
        service1Desc: "Procedimentos revolucionários para proporcionar volume, projeção e definição corporal e facial.",
        service2Title: "Tratamentos Corporais",
        service2Desc: "Procedimentos especializados para modelar o corpo, reduzir medidas e melhorar a aparência da pele.",
        service3Title: "Tecnologias Avançadas",
        service3Desc: "Equipamentos de última geração e técnicas inovadoras para proporcionar os melhores resultados.",
        service4Title: "Protocolos Exclusivos",
        service4Desc: "Tratamentos personalizados desenvolvidos especificamente para as necessidades únicas de cada cliente.",
        knowMore: "Saiba mais",

        aboutSubtitle: "Sobre Nós",
        aboutTitle: "Beleza e Bem-estar em Primeiro Lugar",
        aboutText1: "Na clínica Dra. Lolla, acreditamos que cada pessoa merece sentir-se confiante em sua própria pele. Nossa equipe altamente qualificada combina expertise técnica com um atendimento humanizado e personalizado.",
        aboutText2: "Especialistas em harmonização glútea, oferecemos tratamentos inovadores e seguros, sempre utilizando produtos de alta qualidade e técnicas minimamente invasivas para garantir resultados naturais e satisfatórios.",
        aboutFeature1: "Equipamentos de Última Geração",
        aboutFeature2: "Produtos Certificados",
        aboutFeature3: "Ambiente Acolhedor",
        aboutFeature4: "Horário Flexível",
        aboutButton: "Conheça a Dra. Lolla",
        ...
        servicesPageCard1Desc: "Harmonização de Glúteo",
        ...
        aboutBadgeExperience: "Anos de Experiência",
        aboutStoryTitle: "Nossa História",
        aboutStorySubtitle: "Dra. Lolla: Paixão por Beleza",
        ...
        aboutStoryText4: "A Dra. Lolla possui formação como biomédica e enfermeira, além de especializações em harmonização facial, corporal e íntima, ozonioterapia e diversos cursos internacionais na área da estética avançada, trazendo técnicas modernas e seguras para oferecer resultados naturais e de alta qualidade às suas pacientes.",
        ...
        aboutValue1Desc: "Cada cliente é tratada de forma única e especial. Nosso atendimento é caloroso, respeitoso e personalizado.",
        ...
        aboutValue4Desc: "Satisfação da cliente é nossa maior recompensa. Trabalhamos para superar expectativas a cada visita.",

        aboutQualificationSubtitle: "Qualificação",
        aboutQualificationTitle: "Formação e Certificações",
        aboutQualificationText1: "A Dra. Lolla possui formação sólida em medicina estética, com especializações nas mais renomadas instituições do país. Sua trajetória inclui:",
        aboutQualificationItem1: "Formação em Medicina",
        aboutQualificationItem2: "Especialização em Estética",
        aboutQualificationItem3: "Certificações Internacionais",
        aboutQualificationItem4: "Membro de Sociedades Especializadas",
        aboutQualificationText2: "Participa frequentemente de congressos e eventos internacionais para manter-se atualizada nas mais recentes técnicas e tendências do mercado estético.",

        aboutFooterService1: "Harmonização Glútea",
        aboutFooterService2: "Preenchimento",
        aboutFooterService3: "Botox",
        ...
        footerDescription: "Clínica de estética especializada em harmonização glútea e procedimentos estéticos de alta qualidade. Sua beleza e bem-estar é nossa prioridade.",
        ...
        popupPlaceholder: "Número ou Email",
        popupButton: "Enviar",
        popupWhatsapp: "Falar no WhatsApp",
        popupCloseText: "Fechar",

        alertInvalidContact: "Informe número ou email.",
        alertInvalidFormat: "Número (11 dígitos) ou email válido.",
        alertPopupSuccess: "Obrigado! Entraremos em contato em breve.",
        alertRequiredFields: "Por favor, preencha todos os campos obrigatórios.",
        alertInvalidPhone: "Por favor, informe o telefone completo com DDD (11 dígitos).",
    ...
    en: {
        ...
        aboutFeature4: "Flexible Hours",
        aboutButton: "Meet Dra. Lolla",
        ...
        servicesPageCard1Desc: "Glute Harmonization",
        ...
        servicesPageCard2Item2: "Sculpt Treatment",
        ...
        aboutBadgeExperience: "Years of Experience",
        ...
        popupSubtitle: "Leave your number or email so we can talk now",
        ...
        alertPopupSuccess: "Thank you! We will contact you soon.",
...
/**
 * Configuração do WhatsApp Flutuante (reserva)
 */
...
function customAlert(message, title = 'Alerta') {
    ...
    if (!modal || !modalTitle || !modalMessage || !modalBtn || !modalClose) {
        alert(message);
        return;
    }
