...
const translations = {
  pt: {
    ...
    heroDescription: "Transforme sua silhueta com tratamentos exclusivos de harmonização glútea. Na Dra. Lolla, combinamos tecnologia de ponta com cuidado personalizado para proporcionar resultados naturais e sofisticados.",
    ...
    service1Desc: "Procedimentos avançados para proporcionar volume, projeção e definição corporal e facial.",
    ...
    aboutText2: "Especialistas em harmonização glútea, oferecemos tratamentos inovadores e seguros, utilizando produtos de alta qualidade e técnicas minimamente invasivas para garantir resultados naturais e satisfatórios.",

    aboutFeature1: "Equipamentos de Última Geração",
    aboutFeature2: "Produtos Certificados",
    aboutFeature3: "Ambiente Acolhedor",
    aboutFeature4: "Horários Flexíveis",
    ...
    aboutStoryText4: "A Dra. Lolla é biomédica e enfermeira, com especializações em harmonização facial, corporal e íntima, ozonioterapia e diversos cursos internacionais na área da estética avançada, trazendo técnicas modernas e seguras para oferecer resultados naturais e de alta qualidade às suas pacientes.",
    ...
    aboutQualificationItem1: "Formação em Saúde",
